    ...
    def iterate(self, msg):
        ...
        for day in range(0, 365):
            ...
            for minute in range(0, 1440):
                dayGeneration.append(self.generation(self))
                dayConsumption.append(self.consumption(self))
            allGeneration.append(dayGeneration)
            allConsumption.append(dayConsumption)
